...
public:
  ...
  {}
  ::my_robot_interfaces::srv::CatchTurtle_Request turtle_name(::my_robot_interfaces::srv::CatchTurtle_Request::_turtle_name_type arg)
  {
...
{
  return my_robot_interfaces::srv::builder::Init_CatchTurtle_Request_turtle_name();
}
