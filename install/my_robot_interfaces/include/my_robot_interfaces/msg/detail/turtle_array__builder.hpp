...
public:
  ...
  {}
  ::my_robot_interfaces::msg::TurtleArray alive_turtles(::my_robot_interfaces::msg::TurtleArray::_alive_turtles_type arg)
  {
...
{
  return my_robot_interfaces::msg::builder::Init_TurtleArray_alive_turtles();
}
